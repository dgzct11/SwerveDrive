...
public final class Constants {
    ...
    public static final double[] leftFrontCenter = {-Constants.left_right_wheel_distance/2,Constants.front_back_wheel_distance/2};
    public static final double[] leftBackCenter = {Constants.left_right_wheel_distance/2,Constants.front_back_wheel_distance/2};
